...
%3 - The change in theta (the "gradient") is the sum of the product of X and 
...
%4 - Subtract this "change in theta" from the original value of theta. 
    ...
    h = X * theta;
    errors = h - y;
    total_errors = X' * errors; 
    theta_change = total_errors * alpha / m;  %theta change is the gradient
